...
public class WCDialog extends JDialog implements DocumentListener {
    ...
    public WCDialog() {
        super(null, "WebCam Visualization Configuration", Dialog.ModalityType.APPLICATION_MODAL);
    }

    WCDialog(ProjectOrganization organization) {
        super(null, "WebCam Visualization Configuration", Dialog.ModalityType.APPLICATION_MODAL);
        org = organization;
